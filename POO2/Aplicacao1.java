...
public class Aplicacao1 {
	public static void main(String[] args) {
		...
		//Ingresso i1 = new Ingresso(1, 20.0);
		...
		//Nome dos times que se enfrentam => t1.getJogos();
		//Valor dos ingressos => System.out.println(i1.calcularValor()); 
		...
		System.out.println(i5.calcularValor());
		...
		System.out.println("\n----times (nome, origem e idatd, a e local dos jogos)");
		...
		System.out.println("\n----ingressos emitidos (codigo id do(s) jogo(s)");
